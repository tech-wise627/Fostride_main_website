...
const liquidColors = ["#16a34a", "#0C8346", "#1a1a1a"] // Brighter greens for better visibility
...
export function HeroSection() {
  ...
  return (
    <>
      <section
        id="hero-section"
        className="relative min-h-screen pt-24 pb-16 select-none outline-none"
      >
            ...
            <div className="space-y-8 order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 relative z-50">
                <Button
                  ...
                  className="bg-primary text-primary-foreground hover:bg-primary/90 pointer-events-auto cursor-pointer"
                >
                  Schedule Demo
