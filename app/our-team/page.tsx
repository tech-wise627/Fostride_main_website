                ...
                <main className="pt-32 pb-20 px-[40px]">
                    ...
                    <div className="py-20 mb-20">
                        ...
                        <div className="max-w-5xl mx-auto">
                            {/* Process Item 01 */}
                            <div className="relative grid grid-cols-[100px_1fr] md:grid-cols-[150px_1fr] gap-8 md:gap-16 min-h-[90vh] content-center items-start">
                                {/* Timeline Column */}
                                <div className="flex flex-col items-center">
                                    <span className="text-6xl md:text-7xl font-bold text-[#0C8346] drop-shadow-[0_0_15px_rgba(12,131,70,0.6)]">
                                        01
                                    </span>
                                    {/* Vertical Line */}
                                    <div className="w-0.5 h-full bg-gradient-to-b from-[#0C8346] via-[#0C8346]/50 to-white/5 mt-4 rounded-full min-h-[200px]" />
                                </div>
                                ...
                                <div className="bg-white/5 backdrop-blur-[8px] border border-white/5 rounded-[40px] pt-[20px] px-[30px] pb-[30px] h-[220px] w-[600px]">
                                    ...
                                    <h3 className="text-[20px] font-normal text-white mb-2">
                                        Data Collection & Analysis
                                    </h3>
                                    <p className="text-gray-400 text-[12px] leading-relaxed font-light">
                                        Our journey begins with understanding the waste problem at its roots. Using advanced data-gathering tools, we track waste generation patterns, identify key sources, and analyze its composition. This helps us create targeted and effective solutions for different types of waste streams.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="relative grid grid-cols-[100px_1fr] md:grid-cols-[150px_1fr] gap-8 md:gap-16 min-h-[90vh] content-center items-start">
                                ...
                                <div className="bg-white/5 backdrop-blur-[8px] border border-white/5 rounded-[40px] pt-[20px] px-[30px] pb-[30px] h-[220px] w-[600px]">
                                    ...
                                    <p className="text-gray-400 text-[12px] leading-relaxed font-light">
                                        At the heart of our process lies AI-driven technology. We utilize intelligent algorithms and cutting-edge machines to sort waste into recyclable, reusable, and non-recyclable categories. This precision reduces contamination and ensures that each material is utilized to its fullest potential.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="relative grid grid-cols-[100px_1fr] md:grid-cols-[150px_1fr] gap-8 md:gap-16 min-h-[90vh] content-center items-start">
                                ...
                                <div className="bg-white/5 backdrop-blur-[8px] border border-white/5 rounded-[40px] pt-[20px] px-[30px] pb-[30px] h-[220px] w-[600px]">
                                    ...
                                    <p className="text-gray-400 text-[12px] leading-relaxed font-light">
                                        Once sorted, we focus on transforming waste into valuable resources. Through innovative recycling and upcycling methods, we convert discarded materials into eco-friendly products or energy sources. This ensures minimal waste goes to landfills, contributing to a circular economy.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="relative grid grid-cols-[100px_1fr] md:grid-cols-[150px_1fr] gap-8 md:gap-16 min-h-[90vh] content-center items-start">
                                ...
                                <div className="bg-white/5 backdrop-blur-[8px] border border-white/5 rounded-[40px] pt-[20px] px-[30px] pb-[30px] h-[220px] w-[600px]">
                                    ...
                                    <h3 className="text-[20px] font-normal text-white mb-2">
                                        Impact Assessment & Expansion
                                    </h3>
                                    <p className="text-gray-400 text-[12px] leading-relaxed font-light">
                                        We believe in measurable change. After every project, we assess the environmental and economic impact of our efforts—tracking metrics like waste diverted from landfills and carbon footprint reduction. With this data, we refine our processes and scale our solutions to benefit more communities and industries globally.
                                    </p>
                                </div>
                            </div>
                        </div>
